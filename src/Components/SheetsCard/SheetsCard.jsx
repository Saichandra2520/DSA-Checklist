      ...
      <div>
        <div className="mb-6 box-border w-[330px] h-[185px] border border-black rounded-2xl flex justify-around borderToWhite BGtoBlack">
          <div className="topic-item-primary">
            ...
            <button onClick={handleStartNow} className="bg-black BGtoWhite text-white text-xs font-semibold py-2 px-6 mt-4 ml-3 rounded-lg shadow-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-300">
              Solve Now
            </button>
          </div>
